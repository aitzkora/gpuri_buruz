...
\lstset{ %
  ...
  lineskip=-1pt,
%\ifC
  emph={__global__, __shared__, __device__, __host__, __syncthreads, threadIdx, blockIdx, blockDim, gridDim},
%\else
 ...
 \item Optimisation 
  ...
  \item Divers
     \begin{itemize}
       ...
       \item nouveautés (demi-précision, processeurs tenseurs)
  ...
  \item les {\bf threads} sont implicitement groupés en {\bf warps}
    \begin{itemize}
      ...
      \item tous les threads d'une même chaîne exécutent la même instruction au même cycle logique
        ...
        \end{itemize}
    \end{itemize}
  \item chargement depuis la DRAM coûteux : ratio latence(DRAM) / instruction = 128 \gezi 128 threads pour recouvrir !
\end{itemize}
\end{minipage}
