...
\begin{frame}{Architectures}
  \begin{itemize}[<+->]
    \item la capacité de calcul (CC) dépende de l'architecture
...
\pause
 \begin{tabular}{|l|r|r|r|r|r|r|}
    ...
    \hline
      ...
      Freq(Mhz)  & 1296  & 1150  &  745   &  948    &  1329  &  1380 \\
      SM         & 30    & 14    &  15    &  24     &   56   &   80  \\
      SP (32)    & 240   & 448   &  2880  &  3072   &  3584  &  5120 \\
      Flops (G/s)& 622   & 1030  &  4291  &  5824   & 9526   &  14131\\
    \hline
\end{tabular}
\end{frame}
%****************************************************************
...
\begin{frame}{Bande passante}
  \begin{itemize}[<+->]
    \item {\em Bande Passante} : taux de transfert des données (Go/s)
    \item pic théorique  
  \end{itemize}
\end{frame}
