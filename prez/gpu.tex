...
%****************************************************************
\begin{frame}{Mémoire partagée}{exemple}
  \begin{itemize}[<+->]
    \item[\adibi] on considère un noyau qui tranpose une matrice
  \lstinputlisting[language=C]{code/transposeNaive.c}
    \item[\triste] écriture ou lecture forcement avec un pas \gezi\ non coalescent
    \item[\argi] utilisation d'un cache locale pour rendre les accès coalescents
   \end{itemize}
\end{frame}
