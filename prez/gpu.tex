...
\begin{figure}[h!]
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[ grid=major, legend entries={copy, copy\_ilp}, xlabel=occupation(Go/s), ylabel=BP ]
        \addplot 
        table[x=occ1,y=bp1,col sep=comma] {fig/occupancy.csv}; 
		\addplot 
        table[x=occ2,y=bp2,col sep=comma] {fig/occupancy.csv}; 
      \end{axis}
    \end{tikzpicture}
