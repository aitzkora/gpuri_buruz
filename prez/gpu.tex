...
\else
  \lstinputlisting{code/increment.f90}
\fi
...
\else
      \item \alert{dim3} est un type dérivé avec 3 champs entiers \texttt{\_\%x,\_\%y et \_\%z}
\fi
...
\else
  \lstinputlisting[language=fortran]{code/grille.f90}
\fi
 \end{itemize}
\end{frame}
