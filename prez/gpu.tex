...
\column{5cm}
 passage par adresse
  ...
  \begin{itemize}
   ...
   \end{itemize} 
\end{columns}
\ifC C passe par valeur \else Fortran passe par adresse \fi par défaut !
\end{frame}
%***************************************************************
...
\begin{frame}[fragile]{Modèle en ligne brisée}
\begin{minipage}[c]{0.53\linewidth}
  
  \begin{itemize}
  \item la BP est fonction affine par morceaux de l'occupation (V. Volkov)
  \item analogue d'un modèle Roof-line (BP vs Intensité Arithmétique) pour CPU
   \end{itemize}
\end{minipage}%
