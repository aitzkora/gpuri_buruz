...
\lstset{ %
  ...
  emphstyle=\color{bleuSympa},
  moredelim=[s][\color{bleuSympa}\ttfamily]{<<<}{>>>},
...
\end{center}
  ...
  \lstinputlisting[language=C]{code/overflow.c}
 \end{itemize}
\end{frame}
%****************************************************************
% Coalescence
...
\begin{itemize}[<+->]
  ...
  \item Understanding Latency Hiding on GPUs, V. Volkov \href{http://www2.eecs.berkeley.edu/Pubs/TechRpts/2016/EECS-2016-143.pdf}{\beamergotobutton{pdf}}
