...
\begin{frame}{Réduction}{Principe}
 \begin{itemize}[<+->]
   ...
   \item[\kontuz] il faut faire travailler tous les threads \harritu
   \item[\scout] utiliser une réduction en arbre, mais non divergente
\begin{center}
  \includegraphics[width=0.5\linewidth]{fig/zuhaitz.eps}
\end{center}
  \end{itemize}
\end{frame}
