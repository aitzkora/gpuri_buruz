...
\pause
  ...
  \includeSrc{code/mem1}
     \ifC
     \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/mem1.out}
     \else
     \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/mem1f.out}
     \fi
\end{column}
\pause
  \vrule{}
  ...
  \ifC
  \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/mem2.out}
  \else
  \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/mem2f.out}
  \fi
  \end{column}
\pause
  \vrule{}
  ...
  \ifC
    \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/mem3.out}
  \else
    \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/mem3f.out}
  \fi
  \end{column}
\end{columns}
    \pause
...
%   \end{itemize}
%\pause
%  \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt, lastline=11]{code/outGDB}
%  \begin{itemize}[<+->]
...
%  \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/outMemcheck}
%\end{frame}
%
%%****************************************************************
%% Déverminage : outils I
...
%  \lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/outComputeSanitizer}
%\end{frame}
%
%%****************************************************************
%% Profilage : 
...
%  \end{itemize}
%\pause\lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/outProfile}
%\end{frame}
%
%%****************************************************************
%% Profilatzea
...
%    \item[\pozik] beaucoup plus de métriques et de compteurs disponibles
%  \end{itemize}
%\pause\lstinputlisting[numbers=none,language=bash,basicstyle=\petiteFont,lineskip=2pt]{code/outncu}
%\end{frame}
%
%
%%****************************************************************
...
%          \hline
%          K40 & normal    &  143    &  173   &  142 & 288\\ 
%              & fastmath  &  165    &  172   &  207 & 288 \\ 
%          \hline
%        \end{tabular}
%      \end{center}
%\end{frame}
...
%%%****************************************************************
%\begin{frame}{Parallèlisme d'instruction}
%\pause
%\begin{itemize}[<+->]
...
%    \begin{itemize} 
%     \item mémoire locale est interne à un fil d'exécution
...
%  \begin{itemize}[<+->]
%    \item[\scout] mémoire privée du fil d'exécution hors registre (locale)
...
%\end{frame}
%
%\begin{frame}{Paradigmes de Programmation}
%  \lstset{numbers=none}
%    \pause
%\begin{columns}[T]
%\pause
%  \begin{column}{4cm}
%    {\bf Appels de Bibliothèques}
%  \includeSrc{code/saxpy_cublas}
%\end{column}
%\pause
%  \vrule{}
%  \begin{column}{3.6cm}
%  {\bf Directives}
%  \includeSrc{code/saxpy_mp}
%  \end{column}
%\pause
%  \vrule{}
%  \begin{column}{4.2cm}
%  {\bf Cuda}
%  \ifC
%  \includeSrcCu{code/saxpy_cuda}
%  \else
%  \includeSrc{code/saxpy_cuda}
%  \fi
%  \end{column}
%\end{columns}
%\end{frame}
