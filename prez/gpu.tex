...
\begin{frame}{Mémoires sur l'accélérateur}{Vue générale}
  \begin{itemize}[<+->]
    \item[\argi] un GPU abrite plusieurs catégories de mémoire : 
\begin{tabular}{|l|l|l|l|l|l|}
  \hline
  mémoire   & local. & Cachée  & accès     & portée   & durée \\ 
  \hline
  registre  &  puce  &  N/A   & RW & thread & thread \\
  local     &  DRAM  & CC$\geqslant$2.0 & RW & thread & thread \\
  ...
  \hline
\end{tabular}
  \item[\kontuz] il faut adapter l'accès selon les caractèristiques
  \end{itemize}
\end{frame}
