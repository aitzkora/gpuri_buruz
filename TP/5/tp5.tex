...
\begin{document}
\begin{frame}{Divergence de fils : calcul de $\pi$ par Monte-Carlo}
\begin{itemize}
  \item[\adibi] compiler \texttt{monteCarlo.cu} avec le \texttt{Makefile}
  \item[\adibi] implementer le noyau divergent : penser a le tester en changeant l'appel de verification
  \item[\adibi] implementer le noyau faisant la reduction avec 1 fil 
  \item[\adibi] comparez les performances pour la taille standard
\end{itemize}
\end{frame}
